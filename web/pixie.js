...
// load spine data
PIXI.loader
    .add('background', 'res/iP4_BGtile.jpg')
    .add('foreground', 'res/iP4_ground.png')
    .add('pixie', 'res/Pixie.json')
    .load(onAssetsLoaded);
...
{
    background = PIXI.Sprite.fromImage('res/iP4_BGtile.jpg');
    background2 = PIXI.Sprite.fromImage('res/iP4_BGtile.jpg');
    stage.addChild(background);
    stage.addChild(background2);

    foreground = PIXI.Sprite.fromImage('res/iP4_ground.png');
    foreground2 = PIXI.Sprite.fromImage('res/iP4_ground.png');
